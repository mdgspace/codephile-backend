...
// 		// data, _ := json.Marshal(GetCodeforcesGraphData("Fefer_Ivan"))
// 		data, _ := json.Marshal(GetCodeforcesContests())
// 		// data, _ := json.Marshal(GetCodeforcesProfileInfo("Fefer_Ivan"))
// 		// data, _ := json.Marshal(GetCodeforcesSubmissions("Fefer_Ivan"))
